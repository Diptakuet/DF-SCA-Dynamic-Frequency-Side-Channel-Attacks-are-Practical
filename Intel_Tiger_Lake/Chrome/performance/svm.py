...
x_train=pd.read_csv('X_train_100.csv',header=None)
y_train=pd.read_csv('Y_train_100.csv',header=None)
x_test=pd.read_csv('X_test_100.csv',header=None)
y_test1=pd.read_csv('Y_test_100.csv',header=None)
